...
\[
\mathbb E[\#\text{ successes to reach }w(\varepsilon)=0]\le \left\lceil \frac{w_0(\varepsilon)}{\beta(\varepsilon)}\right\rceil,\qquad
\mathbb E[T_\varepsilon]\ \le\ \frac{1}{q(\varepsilon)\,p(\varepsilon)\,\beta(\varepsilon)}.
\]
\end{theorem}
